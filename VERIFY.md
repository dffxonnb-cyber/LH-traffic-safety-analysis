...
This repository separates public-safe verification from full competition-data reproduction. The public repo is designed to let reviewers inspect the method, validation summary, dashboard fallback behavior, and selected review artifacts without requiring private or restricted raw data.
...
- The repository keeps public documentation, images, dashboard fallback logic, and a small review CSV.
